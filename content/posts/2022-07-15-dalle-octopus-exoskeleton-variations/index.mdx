...
**Trigger warning**: _I'll use anthropomorphic terms for convenience in this post._
...
But let's not get ahead of ourselves, meet the exoskeleton tech first. In order for octopuses to walk free in our world, they need some kind of second skin to exist in. Since they have no bones, this must be made of something light and tough material, like carbon-fibre or some metal alloy.
...
> An octopus walking on a city street wearing a shiny robotic exoskeleton, _gameplay screenshot_
...
DALL-E can do this easily since it's based on machine learning concept called transformers. Quoting from an analytical article:
...
> An octopus _talking to a man_ on a city street wearing a shiny robotic exoskeleton, game screenshot powered by unreal engine
...
> An octopus wearing a shiny robotic exoskeleton talking to a _detective_ man, game screenshot powered by unreal engine
...
> An octopus wearing a _steampunk_ exoskeleton talking to a detective man _from the 50's_, game screenshot powered by unreal engine
...
I hope you enjoyed this little trip to this universe, I certainly did.
