...
I've added gameplay and screenshot to the mix to steer the direction to something more abstract. It did change things, for example the first image looks kinda like Half-life character.

These characters would perfectly into any futuristic game, there are probably some out there already I'm unaware of.
...
Adding back unreal engine again to the prompt results these creatures. The first one is pretty terrifying, it looks like it's running at me.
...
This is a bit glitchy one, but I wanted to showcase lesser good examples as well so this one contains no edits. I like the vibe of it though, the framing is also nice. After regenerating some legs and building parts it would look much better.

![Octopus exoskeleton by DALL-E 2](./images/renders/walking-on-street-gameplay-8.png)

This one is also unedited, really nice outcome.

![Octopus exoskeleton by DALL-E 2](./images/renders/walking-on-street-gameplay-9.png)

### Talking with somebody

I thought that instead of just walking aimlessly on the streets, they should ask for directions. DALL-E now needs to reach out to the concept of what a conversation is and how its participants should behave.
...
I like how the industrial apartment block lurks in the background.
...
I didn't like futuristic nature of the human's outfit so I changed them to something more familiar. To achieve this, I added _"from the 50's"_ to the mix.
...
This is a weird one, the framing is bad, but it makes me wonder, what's on that picture leaning on the wall?
...
Here's an extra take about assembly instructions, we can never get enough documentation :)
